...
class haixuan():
    ...
    def scp_source_package_to_local(self):
        ...
        #从source_host拷贝模块目录
            ...
            sys.exit("You want make it auto update ,Make sure you define source_host/source_path/source_user/source_password")
    ...
    def mv_upload_file_to_backup_dir(self):
        ...
        #复制文件到本地同步目录
            ...
            #如果都没有 退出
                ...
                print "You compress flag is  False,But " +upload_dir + " can't find " + self.mod_name + " directory"
                sys.exit()
